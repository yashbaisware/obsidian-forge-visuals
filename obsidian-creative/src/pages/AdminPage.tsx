    ...
    return (
      <main className="dark min-h-screen bg-background text-foreground flex items-center justify-center">
        <div className="text-muted-foreground text-sm tracking-widest">
          {loading ? "LoadingΓÇª" : "Unauthorized ΓÇö redirectingΓÇª"}
        </div>
      </main>
    );
  }
    ...
    <main className="dark min-h-screen bg-background text-foreground">
      ...
      <div className="mx-auto max-w-7xl px-6 py-12 grid lg:grid-cols-12 gap-10">
        <section className="lg:col-span-5">
          <div className="text-[10px] tracking-[0.3em] uppercase text-primary mb-3">ΓÇö New Project</div>
        ...
        <section className="lg:col-span-7">
          <div className="flex items-center justify-between mb-6">
            <div>
              <div className="text-[10px] tracking-[0.3em] uppercase text-primary mb-3">ΓÇö Projects</div>
              <h2 className="text-2xl text-silver font-semibold">{projects.length} total</h2>
            </div>
          </div>

          {isLoading ? (
            <div className="text-muted-foreground text-sm">LoadingΓÇª</div>
          ) : projects.length === 0 ? (
        ...
        <section className="lg:col-span-12 mt-6 pt-10 border-t border-border">
          <div className="flex items-center justify-between mb-6">
            <div>
              <div className="text-[10px] tracking-[0.3em] uppercase text-primary mb-3">ΓÇö Hero Showcase</div>
...
function ProjectForm({ onSaved }: { onSaved: () => void }) {
  ...
  // Per-category file state (not persisted ΓÇö files can't be JSON-serialized safely)
  ...
  return (
    ...
    >
      ...
      <Field label="Title">
        <input value={title} onChange={(e) => setTitle(e.target.value)} maxLength={120} className="input" placeholder="Lumi├¿re Atelier" />
      </Field>
      ...
      <Field label="Description">
        <textarea
          ...
          placeholder="Short cinematic descriptionΓÇª"
        />
      </Field>
...
// ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ Hero Showcase Manager ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
