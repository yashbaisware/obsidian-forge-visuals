      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        >
          <Link to="/" className="flex items-center gap-3 group">
            <img src={logo} alt="Obsidian Creative" width={40} height={40} className="h-10 w-10 object-contain" />
            <span className="hidden sm:inline font-display text-sm tracking-[0.25em] text-silver">
              OBSIDIAN
            </span>
          </Link>
            ...
            {links.map((l) => (
              <li key={l.label}>
                <button
                  ...
                  className="px-4 py-2 text-sm tracking-wide text-muted-foreground hover:text-foreground transition-colors relative group"
                >
                  {l.label}
          ...
          <button
            ...
            className="hidden md:inline-flex items-center gap-2 rounded-full border border-primary/40 bg-primary/10 px-5 py-2 text-xs tracking-[0.2em] uppercase text-primary hover:bg-primary hover:text-primary-foreground hover:glow-blue transition-all"
          >
            Start Project
          </button>
