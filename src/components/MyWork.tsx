...
export function MyWork() {
  ...
  // Realtime: any change to projects → refresh
  useEffect(() => {
  ...
  return (
    <section id="my-work" className="relative py-32 overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-14">
          <div>
            <div className="text-[10px] tracking-[0.3em] uppercase text-primary mb-4">— Archive</div>
            <h2 className="text-4xl sm:text-5xl lg:text-6xl text-silver font-semibold">My Work</h2>
          </div>
          <p className="max-w-md text-muted-foreground">
            The full archive — every campaign organized by craft. Browse by
            format and explore the work in detail.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-12">
          ...
          <aside className="lg:col-span-3">
            <div className="lg:sticky lg:top-28 flex lg:flex-col gap-2 overflow-x-auto lg:overflow-visible pb-2 lg:pb-0">
              {CATEGORIES.map((c) => {
                ...
                return (
                  <button
                    key={c}
                    onClick={() => setActive(c)}
                    className={`relative flex-shrink-0 lg:w-full text-left rounded-2xl px-5 py-4 border transition-all ${
                      isActive
                        ? "border-primary/50 bg-primary/10 text-silver-bright glow-blue"
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between gap-3">
                      <span className="text-sm tracking-wide font-medium">{c}</span>
                      <span className="text-[10px] tracking-[0.2em] text-primary/80">
          ...
          <div className="lg:col-span-9">
            <AnimatePresence mode="wait">
              ...
              >
                {filtered.length === 0 ? (
                  <div className="rounded-3xl border border-dashed border-border bg-card/30 p-16 text-center text-muted-foreground text-sm tracking-wider">
...
function ProjectCard({
  ...
  return (
    ...
    >
      ...
      <div className="p-6">
        <h3 className="text-xl font-display text-silver-bright">{project.title}</h3>
        {project.description && (
...
// Modal — duplicated locally to keep MyWork self-contained
