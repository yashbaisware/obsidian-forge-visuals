    ...
    <footer className="border-t border-border py-14">
      <div className="mx-auto max-w-7xl px-6 flex flex-col md:flex-row items-center justify-between gap-8">
        ...
        <nav className="flex gap-6 text-xs tracking-[0.2em] uppercase text-muted-foreground">
          <a href="https://instagram.com/obsidian.creative" target="_blank" rel="noreferrer" className="hover:text-foreground transition-colors">Instagram</a>
          <a href="https://wa.me/15550102025" target="_blank" rel="noreferrer" className="hover:text-foreground transition-colors">WhatsApp</a>
          <a href="mailto:studio@obsidiancreative.co" className="hover:text-foreground transition-colors">Email</a>
        </nav>
